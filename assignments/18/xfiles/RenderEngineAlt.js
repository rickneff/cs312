                                            ...
                                            vertexShader, fragmentShader)
{
   ...
   this.renderBuffer.setPixel(screenPos[0], screenPos[1], screenPos[2], color);
}
...
RenderEngine.prototype.drawLine = function(P1, P2, fragmentShader, storeVals)
{
   ...
   this.renderBuffer.setPixel(P1[0][0], P1[0][1], P1[0][2], varsP1);
   
   // Keep this value around for triangle drawing
   // Based on the Y position, store the x position,
   // the varying vals, the w value and the z value.
   if (storeVals != null)
   {
      storeVals[P1[0][1]] = [P1[0][0], varsP1, P1[0][3], P1[0][2]];
   }
   ...
   if (maxDist > 1)
   {
      ...
      for (var i = 1; i < maxDist; i++)
      {
         ...
         this.renderBuffer.setPixel(x, y, z, varyingVars);
         ...
         if (storeVals != null)
         {
            storeVals[y] = [x, varyingVars, Tw[1], z];
         }
      }
   }
   ...
   this.renderBuffer.setPixel(P2[0][0], P2[0][1], P2[0][2], varsP2);
   ...
   if (storeVals != null)
   {
      storeVals[P2[0][1]] = [P2[0][0], varsP2, P2[0][3], P2[0][2]];
   }
}
   ...
   for (var y = topY + 1; y < bottomY; y++)
   {
      ...
      if (rightX > leftX + 1)
      {
         ...
         for (var x = leftX + 1; x < rightX; x++)
         {
            ...
            var z = lerp(leftHold[y][3], rightHold[y][3], tW);
