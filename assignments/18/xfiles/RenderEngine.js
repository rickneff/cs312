...
RenderEngine.prototype.drawLine = function(P1, P2, fragmentShader)
{
   ...
   if (maxDist > 1)
   {
      for (var i = 1; i < maxDist; i++)
      {
         ...
         this.renderBuffer.setPixel(point[0][0], point[0][1], point[0][2],
                                    point[1]);
      }
   }
   
   // Draw the 2 end-points
   this.renderBuffer.setPixel(P1[0][0], P1[0][1], P1[0][2],
                              fragmentShader.main(P1[1]));
   this.renderBuffer.setPixel(P2[0][0], P2[0][1], P2[0][2],
                              fragmentShader.main(P2[1]));
}
...
RenderEngine.prototype.drawTriangle = function(vertArray, fragmentShader)
{
   ...
   if (maxDistL > 1 && maxDist1 > 1 && maxDist2 > 1)
   {
      ...
      for (var i = 1; i <= maxDistL; i++)
      {
         ...
         while (lineS.getY() < lineL.getY())
         {
            ...
            this.renderBuffer.setPixel(pointS[0][0], pointS[0][1], pointS[0][2],
                                       pointS[1]);
         }
   ...
   this.renderBuffer.setPixel(vertArray[0][0][0],
                              vertArray[0][0][1],
                              vertArray[0][0][2],
                              fragmentShader.main(vertArray[0][1]));
   this.renderBuffer.setPixel(vertArray[1][0][0],
                              vertArray[1][0][1],
                              vertArray[1][0][2],
                              fragmentShader.main(vertArray[1][1]));
   this.renderBuffer.setPixel(vertArray[2][0][0],
                              vertArray[2][0][1],
                              vertArray[2][0][2],
